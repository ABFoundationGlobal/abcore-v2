...
const (
	...
	DefaultBlockInterval uint64 = 3000
...
var (
	...
	MinBlocksForBlobRequests           uint64 = MinTimeDurationForBlobRequests * 1000 / FermiBlockInterval // ref: https://github.com/bnb-chain/BEPs/blob/master/BEPs/BEP-524.md#421-change-table.
	DefaultExtraReserveForBlobRequests uint64 = 24 * 3600 * 1000 / FermiBlockInterval                      // it adds more time for expired blobs for some request cases, like expiry blob when remote peer is syncing, default 1 day.
