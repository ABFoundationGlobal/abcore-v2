...
var (
	...
	// ABCoreDevnetGenesisHash is the genesis block hash for ABCore devnet (chain ID 17140).
	// Generated by devnet-ops/jenkins/Jenkinsfile.init from the 5 fixed validator addresses
	// in script/devnet/keystores/val-{0..4}.address (sorted lexicographically) plus
	// clique{period:3, epoch:30000}, gasLimit 0x1C9C380, timestamp 0x0, difficulty 0x1.
	// Stable across geth init re-runs as long as the keystore set does not change.
...
func GetBuiltInChainConfig(ghash common.Hash) *ChainConfig {
	...
	case ABCoreDevnetGenesisHash:
		return ABCoreDevnetChainConfig
	default:
		return nil
	}
}
